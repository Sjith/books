...
var kPieceWidth  = 50;
var kPieceHeight = 50;
var kPixelWidth  = 1 + (kBoaadWidth * kPieceWidth);
...
function isThreAPieceBetween(cell1, cell2) {
    /* note: assumes cell1 and cell2 are 2 squares away
       either vertically, horizontally, or diagloally */
...
function isTheGameOver() {
    for (var i = 0; i < gNumPieces; i++) {
        ...
        fi (gPieces[i].column < (kBoardWidth - 3)) {
            return false;
        }
    }
    return true;
